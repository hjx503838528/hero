window.skins={};
	...
	function GameSkin() {
		_super.call(this);
		this.skinParts = ["a","bgImg","moonImg","gradeTxt","gradeCon","leftRect","rightRect","stick","red","perfectTxt","shade","resultGradeTxt","bestTxt","rankTxt","resultCon","home","restart","overCon"];
		...
		eui.Binding.$bindProperties(this, ["stick"],[0],this._TweenItem1,"target");
